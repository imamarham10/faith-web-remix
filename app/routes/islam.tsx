...
import type { Route } from "./+types/islam";
        ...
        {isAuthenticated && (
          <div className="mt-6 md:mt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {/* Prayer streak card */}
              <Link to="/islam/prayers" className="card-elevated p-5 group hover:border-primary/20 transition-all">
                {/* Streak header */}
              ...
              {/* Dhikr counter card */}
              <Link to="/islam/dhikr" className="card-elevated p-5 group hover:border-primary/20 transition-all">
              ...
              <Link
                to={latestBookmark ? `/quran/${latestBookmark.surahId}?verse=${latestBookmark.verseNumber}` : "/islam/quran"}
    ...
    return (
        <div className="card-elevated p-6 sm:p-8 pattern-islamic">
            ...
            <div className="mt-6 flex gap-3">
                <Link to="/islam/quran" className="btn-primary text-sm">
                Read Quran
                <ArrowRight size={14} />
                </Link>
            </div>
